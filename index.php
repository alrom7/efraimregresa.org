...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="basicExampleNav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="parashot.php">Parashot</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="sidurim.php">Sidurim</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="luaj.php">Luaj</a>
        </li>
...
<footer class="page-footer unique-color-dark">
  ...
  <div class="primary-color">
    ...
    <div class="footer-copyright text-center py-3">Vuelve El Yisrael fresco en Mashiaj Yahushúa
      ...
      <a href="http://efraimregresa.org/"> efraimregresa.org</a>
    </div>
    <!-- Copyright -->
